...
import {
    ArrowLeft, Eye, Clock, Globe, TrendingUp,
    ExternalLink, Loader2, Activity, Calendar
} from 'lucide-react'
...
export default function AnalyticsPage({ params }: { params: Promise<{ slug: string }> }) {
    ...
    const lastVisited = analytics.length > 0
        ? new Date(analytics[0].created_at)
        : null
            ...
            <header className="border-b bg-background/80 backdrop-blur-md sticky top-0 z-50">
                <div className="container mx-auto px-4 h-16 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-xl font-bold tracking-tight">Link Analytics</h1>
                            <p className="text-sm text-muted-foreground">Stats for your link</p>
                        </div>
                    </div>
                ...
                <div className="max-w-7xl mx-auto space-y-8">
                    ...
                    <div className="grid lg:grid-cols-3 gap-6">
                        ...
                        <div className="lg:col-span-2 grid sm:grid-cols-2 gap-4">
                            ...
                            <StatsCard
                                title="Last Visited"
                                value={lastVisited ? lastVisited.toLocaleDateString() : 'Never'}
                                icon={Clock}
                                subtitle={lastVisited ? lastVisited.toLocaleTimeString() : '-'}
                            />
                            <StatsCard
                                title="Created"
                                ...
                                {topReferrers.length === 0 ? (
                                    ...
                                    <div className="space-y-3">
                                        {topReferrers.map(([ref, count], i) => {
                                            ...
                                            const percentage = (count / Math.max(totalViews, 1)) * 100
                                            return (
