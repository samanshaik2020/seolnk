      ...
      <main className="flex-1">
        ...
        <section className="py-24 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto mb-16">
              <h2 className="text-base font-semibold leading-7 text-primary mb-2 uppercase tracking-wide">Workflow</h2>
              <h2 className="text-3xl md:text-5xl font-bold mb-6">Three Simple Steps</h2>
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto relative">
              ...
              <div className="relative group">
                <div className="h-24 w-24 bg-background border border-primary/20 rounded-2xl flex items-center justify-center mx-auto shadow-lg relative z-10 mb-6 group-hover:scale-110 transition-transform duration-300">
                ...
                <h3 className="text-xl font-bold text-center mb-3">Create</h3>
              ...
              {/* Step 2 */}
              <div className="relative group">
                <div className="h-24 w-24 bg-background border border-purple-500/20 rounded-2xl flex items-center justify-center mx-auto shadow-lg relative z-10 mb-6 group-hover:scale-110 transition-transform duration-300">
                ...
                <h3 className="text-xl font-bold text-center mb-3">Share</h3>
                <p className="text-muted-foreground text-center px-4">
              ...
              {/* Step 3 */}
              <div className="relative group">
                <div className="h-24 w-24 bg-background border border-blue-500/20 rounded-2xl flex items-center justify-center mx-auto shadow-lg relative z-10 mb-6 group-hover:scale-110 transition-transform duration-300">
                ...
                <h3 className="text-xl font-bold text-center mb-3">Analyze</h3>
                <p className="text-muted-foreground text-center px-4">
        ...
        <section className="py-24 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            <h2 className="text-4xl md:text-6xl font-bold mb-8 tracking-tight">Ready to <span className="text-primary">Stand Out?</span></h2>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div className="col-span-1 md:col-span-2">
              <Link href="/" className="flex items-center gap-2 mb-4">
                ...
                <span className="font-bold text-lg font-serif">SEOLnk</span>
              </Link>
